...
cpu_types = {
    ...
    "o3": (
        O3_ARM_Cortex_x4.O3_ARM_Cortex_x4,
        O3_ARM_Cortex_x4.O3_ARM_Cortex_x4_ICache,
        O3_ARM_Cortex_x4.O3_ARM_Cortex_x4_DCache,
        O3_ARM_Cortex_x4.O3_ARM_Cortex_x4L2,
    ),
}
...
def main():
    ...
    parser.add_argument("--cpu-freq", type=str, default="3.3GHz")
    parser.add_argument(
