...
class Core(p: Parameters, moduleName: String) extends Module with RequireAsyncReset {
  ...
  io.xnpu.request.valid := score.io.xnpu.request.valid
  io.xnpu.request.bits := score.io.xnpu.request.bits
  score.io.xnpu.request.ready := io.xnpu.request.ready
  score.io.xnpu.reject := io.xnpu.reject
