...
require_log 'Coral XOpenNPU complete sequence=0 .*error=0 .*macs=12 cycles=12' \
    'case 0 completion'
...
require_log 'Coral XOpenNPU complete sequence=2 .*error=0 .*macs=24 cycles=24' \
    'case 1 completion'
...
require_log 'Coral XOpenNPU complete sequence=4 .*error=0 .*macs=12 cycles=12' \
    'case 2 completion'
