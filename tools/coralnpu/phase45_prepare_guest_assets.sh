...
IMAGE="${IMAGE:-${IMAGE_PATH:-${HOME}/wlk/gem5_arm_linux_images}/ubuntu-18.04-arm64-docker.img}"
...
# ---------------------------------------------------------------------------
# Step 3: Install coralctl into the guest image (requires sudo for mount).
# ---------------------------------------------------------------------------
