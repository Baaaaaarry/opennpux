...
cpu_types = {
    ...
    "o3": (
        O3_ARM_Cortex_x2.O3_ARM_Cortex_x2,
        O3_ARM_Cortex_x2.O3_ARM_Cortex_x2_ICache,
        O3_ARM_Cortex_x2.O3_ARM_Cortex_x2_DCache,
        O3_ARM_Cortex_x2.O3_ARM_Cortex_x2L2,
    ),
}
...
def create(args):
    ...
    system.setL3Type(O3_ARM_Cortex_x2.O3_ARM_Cortex_x2_L3)
...
def main():
    ...
    parser.add_argument("--cpu-freq", type=str, default="3.2GHz")
    parser.add_argument(
