...
if [ "$SIM_HOST_FUNCTIONAL" != 0 ]; then
    ...
    if [ "${CORAL_SKIP_HOST_FUNCTIONAL_PREFLIGHT:-0}" = 0 ]; then
        ...
        OPENNPUX_HOST_XGRAPH_GPTQ_MATMUL_SCOPE="${CORAL_HOST_XGRAPH_GPTQ_MATMUL_SCOPE:-none}" \
        OPENNPUX_HOST_XGRAPH_NORMALIZE_SCOPE="${CORAL_HOST_XGRAPH_NORMALIZE_SCOPE:-standard}" \
