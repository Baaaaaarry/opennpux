...
export IMAGE_PATH="${GEM5_ROOT}/image"
export M5_PATH="${IMAGE_PATH}"
export CORAL_CKPT_BOOTSCRIPT="${GEM5_ROOT}/configs/coralnpu/boot-to-checkpoint.rcS"
export CORAL_RESUME_BOOTSCRIPT="${GEM5_ROOT}/configs/coralnpu/fs-run.rcS"
