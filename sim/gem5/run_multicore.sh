...
# Version 13 requires a validated static recovery toolbox and invalidates the
# incomplete BusyBox checkpoints created by versions 11 and 12. It also records
# configuration that affects the DT, physical-memory map,
...
export CORAL_CKPT_FORMAT_VERSION=13
