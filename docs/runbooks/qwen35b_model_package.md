...
`CORAL_GPTQ_ACCUMULATION=fp32|fp64|grouped|wna16|mma16|mma16-bf16` selects an explicit
...
CPU mode clears `CUDA_VISIBLE_DEVICES` in the generator subprocess so GPTQModel
