...
#define OPENNPUX_NPU_WEIGHT_ROLE_ATTENTION_Q_NORM UINT32_C(0xc1d726a2)
#define OPENNPUX_NPU_WEIGHT_ROLE_ATTENTION_K_NORM UINT32_C(0x0dcc4091)
...
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_QKV UINT32_C(0xd07b76c9)
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_ALPHA UINT32_C(0x518a8188)
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_BETA UINT32_C(0xdac7f8e5)
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_GATE UINT32_C(0xbd30c11e)
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_NORM UINT32_C(0x269b83aa)
#define OPENNPUX_NPU_WEIGHT_ROLE_LINEAR_DECAY UINT32_C(0x79fc68a3)

#define OPENNPUX_NPU_WEIGHT_SLOT_MASK UINT64_C(0xffff)
#define OPENNPUX_NPU_WEIGHT_DTYPE_SHIFT UINT32_C(16)
#define OPENNPUX_NPU_WEIGHT_DTYPE_MASK UINT64_C(0xff0000)
...
#define OPENNPUX_NPU_WEIGHT_SLOT_DT_BIAS UINT32_C(9)
#define OPENNPUX_NPU_WEIGHT_SLOT_A_LOG UINT32_C(10)
