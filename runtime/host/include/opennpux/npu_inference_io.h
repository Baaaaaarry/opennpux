#ifndef OPENNPUX_NPU_INFERENCE_IO_H
#define OPENNPUX_NPU_INFERENCE_IO_H
...
#define OPENNPUX_NPU_INFERENCE_MAX_RESULT_TOKENS UINT32_C(32)
#define OPENNPUX_NPU_INFERENCE_TOKEN_IDS_OFFSET UINT32_C(256)
#define OPENNPUX_NPU_INFERENCE_TOKEN_IDS_SOURCE_INDEX UINT32_C(0)
#define OPENNPUX_NPU_INFERENCE_TOKEN_TEXT_SIZE_INDEX UINT32_C(1)
#define OPENNPUX_NPU_INFERENCE_TOKEN_COUNT_INDEX UINT32_C(2)
#define OPENNPUX_NPU_INFERENCE_STOP_REASON_INDEX UINT32_C(3)
#define OPENNPUX_NPU_INFERENCE_TOKEN_IDS_OFFSET_INDEX UINT32_C(4)
#define OPENNPUX_NPU_INFERENCE_TOKEN_IDS_BYTES_INDEX UINT32_C(5)
#define OPENNPUX_NPU_INFERENCE_REUSE_DECODE_WEIGHTS UINT32_C(1)
#define OPENNPUX_NPU_INFERENCE_SOURCE_HOST_FUNCTIONAL UINT32_C(0x48464350)
